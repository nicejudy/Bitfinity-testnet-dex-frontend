          ...
          <FormContainer>
            <Box mt="12px">
              <Flex width="100%" justifyContent="space-between" px="5px" mb="10px">
                <Text color="primary">{type === TOKEN_TYPE.NORMAL ? "Token Address" : "Pair Address"}</Text>
              ...
              {type === TOKEN_TYPE.LP && <>
                ...
                <Flex width="100%" justifyContent="space-between" px="5px" mb="10px">
                    <Text color="primary">Factory Address</Text>
        ...
        <Box p="12px" position="inherit">
          ...
          <FormContainer>
            <Box mt="12px">
              ...
              <Flex width="100%" justifyContent="space-between" px="5px" mb="10px">
                <Text color="primary">Unlock Date</Text>
          ...
          {lockInfo.owner === account && <FormContainer>
            <Flex width="100%" alignItems="center" flexDirection={["column", "column", "row"]} mb="12px">
              <Box mr={["0", "0", "15px"]} mb={["10px", "10px", "0"]} width="100%">
                ...
                ><Text color="text" fontSize="14px">Transfer Lock Ownership</Text></Button>
              </Box>
              <Box width="100%">
                <Button
                  width="100%"
                ...
                ><Text color="text" fontSize="14px">Renounce Lock Ownership</Text></Button>
              </Box>
            </Flex>
            <Flex width="100%" alignItems="center" flexDirection={["column", "column", "row"]}>
              <Box mr={["0", "0", "15px"]} mb={["10px", "10px", "0"]} width="100%">
                ...
                ><Text color="text" fontSize="14px">Update</Text></Button>
              </Box>
              <Box width="100%">
                <Button
                  width="100%"
