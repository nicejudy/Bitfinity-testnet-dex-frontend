          ...
          <FormContainer>
            <Box mt="12px">
              <Flex width="100%" justifyContent="space-between" px="5px" mb="10px">
                <Text color="primary">{type === TOKEN_TYPE.NORMAL ? "Token Address" : "Liquidity Address"}</Text>
                <LinkExternal href={getBlockExploreLink(tokenInfo.address, 'address', chainId)}>
                  {accountEllipsis(tokenInfo.address)}
                </LinkExternal>
              </Flex>
              ...
              <Flex width="100%" justifyContent="space-between" px="5px" mb="10px">
                <Text color="primary">Current Locked Amount</Text>
