  ...
  return (
    <Modal title="Edit Description" onDismiss={onDismiss}>
      <Box width={["100%", "100%", "100%", "420px"]}>
        <Box width="100%">
          <Text fontSize="12px" color="primary">Input Title*</Text>
          <Input
            id="lock-owner-input"
        ...
        <ModalActions>
          ...
          {pendingTx ? (
            <Button width="100%" variant="primary" height="36px" isLoading={pendingTx} endIcon={<AutoRenewIcon spin color="currentColor" />}>
              Confirming
            </Button>
          ) : (
            <Button
